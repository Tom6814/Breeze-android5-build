...
class _SearchStates implements SearchStates {
  const _SearchStates({this.from = 'jm', this.searchKeyword = "", this.sortBy = 1, final  Map<String, dynamic> pluginExtern = const <String, dynamic>{}, final  Map<String, bool> aggregateSources = const <String, bool>{'jm' : true}}): _pluginExtern = pluginExtern,_aggregateSources = aggregateSources;
